...
%   A:       d*K, spatial components. Note that the spatial component is
%             fixed
...
if flag_AY
    ...
    U = double(mm_fun_lomem(A,Y)); % here mm_fun_lomem is just a matrix multiplication
end
